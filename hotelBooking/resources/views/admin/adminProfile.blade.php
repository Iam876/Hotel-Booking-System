                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ !empty($profileData->photo) ? url('upload/adminImages/' . $profileData->photo) : url('upload/no_image.jpg') }}"
                                    ...
                                    <div class="mt-3">
                                        ...
                                        @endphp
                                        <p>Profile Completed : {{ $completionPercentage }}% </p>
                                        <div class="progress mb-3" style="height: 14px">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $completionPercentage }}%"
                                                aria-valuenow="{{ $completionPercentage }}" aria-valuemin="0" aria-valuemax="100">{{ $completionPercentage }}%</div>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control datepicker flatpickr-input active"
                                                value="{{ $profileData->dateOfBirth }}" name="dateOfBirth"
                                                readonly="readonly" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input class="form-control form-control-sm" name="photo" id="uploadImage"
                                                type="file">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <img class="mb-0 w-25" id="showImage"
                                                src="{{ !empty($profileData->photo) ? url('upload/adminImages/' . $profileData->photo) : url('upload/no_image.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="row">
